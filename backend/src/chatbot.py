...
class Chatbot:
    ...
    def get_response(self, stop_name, direction, train, current_delay, train_data, stop_data) -> Response:
...
"""
        ...
        return Response(stop=stop_name, direction=direction, train=train, delay=current_delay, response=response.text)
